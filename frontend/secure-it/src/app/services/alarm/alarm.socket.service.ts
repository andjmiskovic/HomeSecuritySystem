...
import {AlarmWebsocketShareService} from "./alarm.websocketshare.service";

@Injectable({
  providedIn: 'root'
})
export class AlarmWebSocketAPI {
  webSocketEndPoint: string = environment.apiUrl + "/ws";
  topic: string = "/user/queue/alarms"
  stompClient: any;
  loggedUser: User | undefined;

  constructor(private websocketShare: AlarmWebsocketShareService, private authService: AuthService) {
